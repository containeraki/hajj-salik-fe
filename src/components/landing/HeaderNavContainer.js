            ...
            <div className="container">
                ...
                <div className="collapse navbar-collapse" id="mainNav">
                    <div className="navbar-nav">
                        <NavLink className="nav-item nav-link" exact activeClassName="active" to="/">Salik Home</NavLink>
                        <NavLink className="nav-item nav-link" activeClassName="active" to="/courses" >Shipments</NavLink>
                        <NavLink className="nav-item nav-link" activeClassName="active" to="/track">Track</NavLink>
